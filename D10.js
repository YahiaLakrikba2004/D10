...
console.log(splitMe('Ciao, come stai?')) // Questo stamperà ['Ciao,', 'come', 'stai?']
...
console.log(deleteOne('casa', false))
...
function isTodayMyBirthday(birthday) {
  ...
  return todayDate === birthday
}

const myBirthday = '02-13-2004'
...
let numberOfMovies1 = newestMovie(movies)
console.log(numberOfMovies1)
...
let numberOfMovies2 = countMovies(movies)
console.log(numberOfMovies2)
...
let lastMillenniumMovies = onlyInLastMillennium(movies)
...
let sumOfYears = sumAllTheYears(movies)
...
let moviesWithTitle = searchByTitle(movies, 'lord')
...
let dividedMovies = searchAndDivide(movies, 'lord')
...
let tdElements = selectAllTdTags()
...
*/
function aggiungiElementoLista(elemento) {
  let lista = document.getElementById('myList')
  let nuovoElemento = document.createElement('li')
  nuovoElemento.textContent = elemento
  lista.appendChild(nuovoElemento)
}
aggiungiElementoLista('Nuovo elemento')
/* ESERCIZIO 25
